...
|- - align="right" |SXP:Main[ Source-Group Tag eXchange Protocol]
|SXP:Lithium:Release_Plan[Release Plan] |1 |Miloslav Radakovic
|mradakov@cisco.com |Miloslav Radakovic (mradakov@cisco.com) |Miloslav
Radakovic (mradakov@cisco.com) |- - align="right" |TCPMD5:Main[ TCP-MD5]
|TCPMD5:Lithium_Release_Plan[Release Plan] |1 |Robert Varga
|rovarga@cisco.com |Robert Varga |Dana Kutenicsova (dkutenic@cisco.com)
|- - align="right" |Topology_Processing_Framework:Main[ Topology
